        ...
        <div>
          ...
          <div className="space-y-1">
            <p className="text-gray-800 font-semibold space-x-2">
              ...
              <span className="uppercase" style={{color: stock > 0? "green" : "red"}}>{stock > 0?"In stock" : "Not Available"}</span>
            </p>
            ...
            <p className="text-gray-800 space-x-2">
             ...
             <span className="text-primary font-semibold"><FormatNumber price={price}/></span>
             <span className="text-gray-500 text-base"><del><FormatNumber price={price + 250000}/></del></span>
            </p>
          </div>
